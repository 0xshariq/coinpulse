    ...
    <footer className="border-t border-dark-400 mt-12">
      <div className="container inner py-10 grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        <div className="space-y-4">
          ...
          <p className="mt-3 text-sm text-purple-100/75 max-w-sm">
            A lightweight crypto dashboard with live prices, charts and market data — built for
            traders and curious folks.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-purple-100/80">
            ...
            <li>
              <a
                className="hover:text-white"
                href="https://github.com/0xshariq/coinpulse"
                target="_blank"
                rel="noopener noreferrer"
              >
                Source on GitHub
            ...
            <li className="flex items-center gap-3 pt-2">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="text-purple-100/80 hover:text-white"
              >
                <svg
                  width="20"
                  height="20"
